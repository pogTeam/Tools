...
def banner():
    print '**************************************************'
    print 'PyCrackZip by: E4404_404'
    print 'pogTeam: https://github.com/pogTeam/'
    print '**************************************************\n'
...
def usage():
    print '**************************************************'
    print 'Usage: '
    print ' -f: specify zip file'
    print ' -d: specify dictionary file\n'
    print 'example: ./pyzip.py -f file.zip -d wordlist \n'
    print '**************************************************'

def extractFile(zFile, password):
    try:
        zFile.extractall(pwd=password)
        print '[+] Found password: ' + colored(password,'green') + '\n'
        return "Found"
    except:
        pass
...
def main():
    ...
    for line in passFile.readlines():
        password = line.strip('\n')
        test = extractFile(zFile, password)
        if(str(test) == "Found"):
            exit(0)
